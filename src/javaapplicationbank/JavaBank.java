...
import javaapplicationbank.CompanyColor;
import javax.swing.*;
...
public class JavaBank extends JFrame {
    ...
    private String displayAccountDetails(String bName, String aName, int aNum, int aBal) {
    ...
    private void DisplayJButtonActionPerformed(ActionEvent event) {
        ...
        if (noAccounts == 0) {
            ...
            for (int i = 0; i < noAccounts; i++) {
                displayJTextArea.append(displayAccountDetails(myAccounts[i].getBankName(), myAccounts[i].accountname, myAccounts[i].getaccountnum(), myAccounts[i].getbalance()));
